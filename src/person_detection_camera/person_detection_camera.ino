...
void setup() {
  ...
  setLED(1, 0, 0, 0);
  Serial.begin(115200);
  Serial.println("VC0706 Camera Person Detection");
...
void loop() {
  ...
  if(person_score_int > 60) {
    setLED(0,0 , BRIGHTNESS, 0); // Green
  } else if (person_score_int > 40) {
    setLED(0,BRIGHTNESS / 2 , BRIGHTNESS / 2, 0); // Yellow
  } else {
    setLED(0,BRIGHTNESS , 0, 0); // Yellow
  }
